...
\descript{Open-Source TEE by Linaro}
...
\descript{| Linaro Assignee Security Working Group}

\location{Apl 2014 – Present | Hsintsu, Taiwan}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\runsubsection{Wistron NeWeb Corporation (WNC)}
